...
SUB rand
    ...
    DO
        ...
        answer = INPUT$(1)
        answer = UCASE$(answer)
        IF answer = "C" THEN inputscreen1
        IF answer = "L" THEN load
        IF answer = "T" THEN inputscreen
...
SUB inputscreen
    ...
    LOOP WHILE INSTR("abcdeABCDE", file) > 0 AND LEN(file) = 1
END SUB
